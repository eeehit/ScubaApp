...
class SiteAdapter(val context: Context, val siteList: ArrayList<Site>, val itemClick: (Site) -> Unit) :
    RecyclerView.Adapter<SiteAdapter.Holder>() {

    override fun onCreateViewHolder(p0: ViewGroup, viewType: Int): Holder {
        val view = LayoutInflater.from(context).inflate(R.layout.activity_site_item, p0, false)
